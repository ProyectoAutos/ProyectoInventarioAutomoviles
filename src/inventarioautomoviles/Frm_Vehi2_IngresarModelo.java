 ...
 * @author Javier
 */
public class Frm_Vehi2_IngresarModelo extends javax.swing.JFrame {
    ...
    public Frm_Vehi2_IngresarModelo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Vehi2_IngresarModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Vehi2_IngresarModelo().setVisible(true);
            }
        });
    }
